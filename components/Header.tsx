...
import { Menu, X, ChevronRight, ShoppingBag, Brain, Mail } from 'lucide-react';
        ...
        >
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      layoutId="nav-pill"
                      className="absolute inset-0 bg-brand-yellow/10 border border-brand-yellow/30 rounded-full shadow-[0_0_15px_rgba(255,184,0,0.15)]"
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className="hidden md:flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-[0.2em] hover:bg-brand-yellow hover:text-black transition-all active:scale-95"
            >
              <Mail size={14} />
